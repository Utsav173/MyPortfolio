...
export function ProjectCard({
  ...
  // Event handlers specifically for motion.div
  const handleMotionMouseMove: React.MouseEventHandler<HTMLDivElement> = (
    e
  ) => {
  ...
  const handleMotionMouseLeave: React.MouseEventHandler<
    HTMLDivElement
  > = () => {
  ...
  return (
    <motion.div
      ...
      onMouseMove={handleMotionMouseMove} // Use correctly typed handler
      onMouseLeave={handleMotionMouseLeave} // Use correctly typed handler
