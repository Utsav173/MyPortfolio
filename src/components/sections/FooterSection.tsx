...
const FooterSectionComponent = () => {
  ...
  return (
    <footer className="relative z-20 w-full border-t border-border/30 bg-background/80 dark:bg-background/60 backdrop-blur-xl shadow-[0_-2px_24px_0_rgba(0,0,0,0.10)] mt-4 overflow-x-hidden">
      <div className="mx-auto flex flex-col items-center justify-center gap-3 py-8 px-4 max-w-4xl">
        ...
        <GooglePreferredSource variant="link" />
      </div>
    </footer>
  );
};
