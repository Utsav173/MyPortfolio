...
const projectsData = [
  {
    ...
    repoUrl: 'https://github.com/Utsav173/zenledger-app',
    liveUrl: 'https://temporal.khatriutsav.com',
    imageUrl:
      'https://cdn.jsdelivr.net/gh/Utsav173/assests@master/portfolio-images/projects/zenledger.webp',
    projectType: 'Cross-Platform Mobile & Web App',
    keyFeatures: [
      "On-Device AI Pipeline: Utilizes Google's Gemma model via LiteRT (TensorFlow Lite) for privacy-first, offline financial data extraction from PDFs and images.",
      'High-Performance Virtualization: Implements @legendapp/list for ultra-efficient 60fps scrolling across infinite transaction histories with zero lag.',
      'Self-Healing Data Logic: Advanced AI orchestration layer that combines LLM inference with programmatic extraction to ensure 100% accuracy in financial parsing.',
      "Generative Financial Art: Features 'Ledger Horizon,' a p5.js-driven ridge plot that visualizes spending velocity and net-worth trends in real-time.",
      'Offline-First Core: Robust SQLite-driven architecture with structured repository patterns for absolute data sovereignty and local-first synchronization.',
    ],
    techStack: [
      'React Native (Expo)',
      'Google Gemma (AI)',
