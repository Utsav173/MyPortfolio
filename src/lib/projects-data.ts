...
const projectsData = [
  {
    ...
    keyFeatures: [
      'Local-First architecture using a high-performance SQLite engine for absolute privacy and zero cloud dependency.',
      'Comprehensive wealth tracking for diverse assets: Stocks, Mutual Funds, Gold/Commodities, and Fixed Income.',
      'Real-time investment analytics calculated locally, including XIRR, CAGR, and cumulative growth metrics.',
      'Biometric security enclave and Recovery Kit for secure, sovereign data management without third-party exposure.',
      'Swiss Financial Brutalist UI (Financial Times aesthetic) with a premium, high-end trading terminal feel.',
    ],
    techStack: [
      'React Native (Expo)',
      'TypeScript',
